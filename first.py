...
if __name__=="__main__":
    ...
    #ter = AICom.AICom(port=8882, name="firstCoup1",strat='f',matricules= ["14545", "67780"])
    #quar = AICom.AICom(port=8883,name="firstCoup2",strat='f',matricules= ["98765","14758"])

    #pent = AICom.AICom(port=8884, name="mine1",strat= 'n', matricules=["14555", "67555"])
    #hex = AICom.AICom(port=8885, name="mine2",strat= 'n',matricules= ["98666", "14666"])
